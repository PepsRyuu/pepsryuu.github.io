...
function prepareView() {
    ...
    if (!_(this).smoothScrolling) {
        ...
        _(this).view.scrollbar.addEventListener('scroll', function () {
            var offset = parseInt(_(this$1).view.scrollbar.scrollTop / _(this$1).itemHeight) * _(this$1).itemHeight;
            _(this$1).view.content.style.transform = "translateY(" + offset + "px)";
        }, true);
    }
    ...
    _(this).view.scrollbar.addEventListener('scroll', function (e) {
        var newScrollTop = _(this$1).view.scrollbar.scrollTop;
